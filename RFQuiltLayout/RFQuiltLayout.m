...
- (BOOL) traverseTilesBetweenUnrestrictedDimension:(NSUInteger)begin and:(NSUInteger)end
                                          iterator:(BOOL(^)(CGPoint))block {

  // the double ;; is deliberate, the unrestricted dimension should iterate indefinitely
  for(NSUInteger unrestrictedDimension = begin; unrestrictedDimension < end; unrestrictedDimension ++) {
